<?php
    ...
    $first_query = "SELECT datetime,Regen FROM wetterdaten2024 PARTITION (p_wetterdaten_24_1) ORDER BY datetime ASC LIMIT 1";
    ...
    ///zweiter Wert Pro Monat
        $last_query = "SELECT datetime,Regen FROM wetterdaten2024 PARTITION (p_wetterdaten_24_3) ORDER BY datetime DESC LIMIT 1";

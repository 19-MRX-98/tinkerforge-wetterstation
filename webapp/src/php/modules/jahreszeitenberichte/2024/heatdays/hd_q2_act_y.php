<?php
    ...
    if($db->connect_errno)
            ...
            else
            {
               ...
               $get_avg_q1 = "SELECT COUNT(*) from tageshöchstwerte24 PARTITION (p_tageshöchstwerte24_04,p_tageshöchstwerte24_05,p_tageshöchstwerte24_06) WHERE Höchstwert BETWEEN 30 AND 34.9";

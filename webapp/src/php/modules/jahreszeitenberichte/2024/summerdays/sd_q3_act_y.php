<?php
    ...
    if($db->connect_errno)
            ...
            $get_avg_q1 = "SELECT COUNT(*) from tageshöchstwerte24 PARTITION (p_tageshöchstwerte24_07,p_tageshöchstwerte24_08,p_tageshöchstwerte24_09) WHERE Höchstwert BETWEEN 25 AND 29.9";

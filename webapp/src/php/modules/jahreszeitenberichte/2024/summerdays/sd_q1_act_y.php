    ...
    if($db->connect_errno)
            ...
            else
            {
                //$db->set_charset("utf-8");
                    $get_avg_q1 = "SELECT COUNT(*) from tageshöchstwerte24 PARTITION (p_tageshöchstwerte24_01,p_tageshöchstwerte24_02,p_tageshöchstwerte24_03) WHERE Höchstwert BETWEEN 25 AND 29.9";

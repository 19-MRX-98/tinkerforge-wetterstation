    ...
    if($db->connect_errno)
            ...
            else
            {
                //$db->set_charset("utf-8");
                    $get_avg_q1 = "SELECT count(*) from wetterdaten01 PARTITION (p_wetterdaten_act_01,p_wetterdaten_act_02,p_wetterdaten_act_03) WHERE temperatur < 0 GROUP BY DATE(DATETIME)";

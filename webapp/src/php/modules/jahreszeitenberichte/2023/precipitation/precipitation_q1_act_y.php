<?php
    ...
    $first_query = "SELECT datetime,Regen FROM wetterdaten2023 PARTITION (p_wetterdaten_23_1) ORDER BY datetime ASC LIMIT 1";
    ...
    ///zweiter Wert Pro Monat
        $last_query = "SELECT datetime,Regen FROM wetterdaten2023 PARTITION (p_wetterdaten_23_3) ORDER BY datetime DESC LIMIT 1";

<?php
    ...
    if($db->connect_errno)
            ...
            $get_avg_q1 = "SELECT COUNT(*) from tageshöchstwerte23 PARTITION (p_tageshöchstwerte23_07,p_tageshöchstwerte23_08,p_tageshöchstwerte23_09) WHERE Höchstwert BETWEEN 25 AND 29.9";

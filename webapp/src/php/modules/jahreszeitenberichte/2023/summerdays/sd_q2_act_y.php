<?php
    ...
    if($db->connect_errno)
            ...
            else
            {
               ...
               $get_avg_q1 = "SELECT COUNT(*) from tageshöchstwerte23 PARTITION (p_tageshöchstwerte23_04,p_tageshöchstwerte23_05,p_tageshöchstwerte23_06) WHERE Höchstwert BETWEEN 25 AND 29.9";

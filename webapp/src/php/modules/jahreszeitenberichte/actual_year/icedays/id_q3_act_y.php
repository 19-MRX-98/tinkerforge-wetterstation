<?php
    ...
    if($db->connect_errno)
            ...
            $get_avg_q1 = "SELECT COUNT(Höchstwert) from tageshöchstwerte PARTITION (p_tageshöchstwerte_07,p_tageshöchstwerte_08,p_tageshöchstwerte_09) WHERE Höchstwert <= 0";

    ...
    if($db->connect_errno)
            ...
            else
            {
                //$db->set_charset("utf-8");
                    $get_avg_q1 = "SELECT COUNT(*) from tageshöchstwerte PARTITION (p_tageshöchstwerte_01,p_tageshöchstwerte_02,p_tageshöchstwerte_03) WHERE Höchstwert BETWEEN 25 AND 29.9";

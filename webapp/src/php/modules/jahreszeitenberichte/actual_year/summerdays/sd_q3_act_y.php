<?php
    ...
    if($db->connect_errno)
            ...
            $get_avg_q1 = "SELECT COUNT(*) from tageshöchstwerte PARTITION (p_tageshöchstwerte_07,p_tageshöchstwerte_08,p_tageshöchstwerte_09) WHERE Höchstwert BETWEEN 25 AND 29.9";

<?php
    ...
    if($db->connect_errno)
            ...
            else
            {
               ...
               $get_avg_q1 = "SELECT COUNT(*) from tageshöchstwerte PARTITION (p_tageshöchstwerte_04,p_tageshöchstwerte_05,p_tageshöchstwerte_06) WHERE Höchstwert BETWEEN 30 AND 34.9";

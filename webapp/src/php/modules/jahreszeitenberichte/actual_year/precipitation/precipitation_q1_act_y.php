<?php
    ...
    $first_query = "SELECT datetime,Regen FROM wetterdaten01 PARTITION (p_wetterdaten_act_01) ORDER BY datetime ASC LIMIT 1";
    ...
    ///zweiter Wert Pro Monat
        $last_query = "SELECT datetime,Regen FROM wetterdaten01 PARTITION (p_wetterdaten_act_03) ORDER BY datetime DESC LIMIT 1";

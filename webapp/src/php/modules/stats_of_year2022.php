<?php
    ...
    if($db->connect_errno)
            ...
            // $db->set_charset("utf-8");
                    $get_topwerte22 = "SELECT Temperatur, DATE_FORMAT(datetime,'%d.%m.%Y') FROM wetterdaten2022 WHERE Temperatur=(SELECT MAX(Temperatur) FROM wetterdaten2022) LIMIT 1;";
                    ...
                    $get_topwerte04="SELECT Temperatur, DATE_FORMAT(datetime,'%d.%m.%Y') FROM wetterdaten2022 WHERE Temperatur=(SELECT MIN(Temperatur) FROM wetterdaten2022) LIMIT 1;";
                    ...
                    $get_topwerte02="SELECT Windboen, DATE_FORMAT(datetime,'%d.%m.%Y') FROM wetterdaten2022 WHERE Windboen=(SELECT MAX(Windboen) FROM wetterdaten2022) LIMIT 1;";
                    ...
                    //Vierte Abfrage
                    $get_topwerte4="SELECT (SELECT MAX(Regen) FROM wetterdaten2022 ORDER BY date(datetime) DESC Limit 1)+(SELECT Regen FROM wetterdaten2022 ORDER BY date(datetime) DESC Limit 0,1) AS Gesamt;";
                    ...
                    $get_avg_jahresmittel="Select AVG(Temperatur) AS Jahresmitteltemperatur from wetterdaten2022";
                    ...
                    $get_warme_tage="Select Count(MaxTemp) AS AnzahlWarmetage from warmetage2022";
                    ...
                    $get_heiße_tage="Select Count(MaxTemp) AS AnzahlHeißeTage from heissetage2022";
                    ...
                    $get_wüesten_tage="Select Count(MaxTemp) AS AnzahlHeißeTage from wuestentage2022";
                    ...
                    $get_avg_feuchte="Select AVG(Feuchte) AS Mittlerefeuchte from wetterdaten2022;";
                    ...
                    $get_max_pressure="Select date(datetime), MAX(airpressure) AS MaxPressure from airpressure2022;";
                    ...
                    $get_min_pressure="Select date(datetime), MIN(airpressure) AS MINPressure from airpressure2022;";
                    ...
                    $get_avg_pressure="Select date(datetime), AVG(airpressure) AS AVGPressure from airpressure2022;";

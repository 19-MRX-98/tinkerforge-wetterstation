<?php
    ...
    require_once ('src/jpgraph-4.4.2/src/jpgraph_ttf.inc.php');
        ...
        $get_avg_per_month = "SELECT MONTH(datetime) AS month, AVG(temperatur)/10 AS avg_temp FROM wetterdaten01 GROUP BY MONTH(datetime)";
        ...
        $graph->Stroke("src/php/jpgaph_diagrams/jpg/avg_chart_act.jpg");
?>
<?php
    $ini_array = parse_ini_file("config/cloudpanel.ini", true, INI_SCANNER_RAW);
?>
 <div class="container my-5">
                            ...
                            <ul class="list-group">
                                <?php foreach ($values as $key => $value): ?>
                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                        ...
                                        <?php if (!in_array($key, non_editable_keys_cloudpanel()) && !in_array($section, non_editable_sections_cloudpanel())): ?>
                                            <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#editModal2" data-section="<?php echo htmlspecialchars($section); ?>" data-key="<?php echo htmlspecialchars($key); ?>" data-value="<?php echo htmlspecialchars($value); ?>">
                                                Bearbeiten
                                            </button>
                                        <?php endif; ?>
                                    </li>
    ...
    <div class="modal fade" id="editModal2" tabindex="-1" aria-labelledby="editModal2Label" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form method="post" action="/edit_cloudpanel_ini">
                    <div class="modal-header">
                        <h5 class="modal-title" id="editModal2Label">Wert bearbeiten</h5>
    ...
    <script>
        ...
        editModal2.addEventListener('show.bs.modal', function (event) {
            ...
            var modalSection = editModal2.querySelector('.modal-body #section');
            var modalKey = editModal2.querySelector('.modal-body #key');
            var modalValue = editModal2.querySelector('.modal-body #value');
